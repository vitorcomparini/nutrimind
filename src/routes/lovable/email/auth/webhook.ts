...
const EMAIL_SUBJECTS: Record<string, string> = {
  ...
  invite: "Seu convite para o NutriMind Club",
...
// Configuration
const SITE_NAME = "NutriMind Club";
const SENDER_DOMAIN = "notify.nutrimindclub.com.br";
const ROOT_DOMAIN = "nutrimindclub.com.br";
const FROM_DOMAIN = "nutrimindclub.com.br";
